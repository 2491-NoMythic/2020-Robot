...
public class timeDrive extends CommandBase {
  ...
  public timeDrive(Drivetrain driveTransfer, double speedDriveTransfer, double timeTransfer) {
    TrainLivesToDrive = driveTransfer;
    addRequirements(TrainLivesToDrive);
  ...
  public void initialize() {
    TrainLivesToDrive.drivePercentOutput(speedOfDrive);
    activeTimer.start();
  }
  ...
  public void end(boolean interrupted) {
    TrainLivesToDrive.stop();
  }

  // Returns true when the command should end.
  @Override
  public boolean isFinished() {
    return timeOfDrive < activeTimer.getDuration();
  }
}
